(function (global, factory) {
	...
	(factory((global.ng = global.ng || {}, global.ng.fabSpeedDial = {}),global.ng.core));
...
var FabSpeedDialComponent = /** @class */ (function () {
    ...
    FabSpeedDialComponent.propDecorators = {
        ...
        'toggle': [{ type: core.ContentChild, args: [FabToggleDirective, { read: core.ElementRef },] },],
        'buttons': [{ type: core.ContentChildren, args: [FabButtonDirective, { read: core.ElementRef },] },],
        'onDocumentClick': [{ type: core.HostListener, args: ['document:click', ['$event.target'],] },],
    };
    return FabSpeedDialComponent;
}());

var Ng2FabSpeedDialModule = /** @class */ (function () {
    function Ng2FabSpeedDialModule() {
    }
    Ng2FabSpeedDialModule.decorators = [
     ...
     * @nocollapse
     */
    Ng2FabSpeedDialModule.ctorParameters = function () { return []; };
    return Ng2FabSpeedDialModule;
}());

exports.Ng2FabSpeedDialModule = Ng2FabSpeedDialModule;
exports.FabToggleDirective = FabToggleDirective;
exports.FabButtonDirective = FabButtonDirective;
